...
const HeroSection = () => {
  return (
    // for dextoop
    <div>
      <div className="lg:bg-[url('/image/creitBg.png')] md:bg-[url('/image/creitBg.png')] md:block md:h-screen  h-screen hidden  lg:block">
      ...
      {/* // for mobile */}
      <div className="lg:hidden md:hidden  block bg-[url('/image/bgMobile.png')] bg-cover bg-no-repeat bg-inherit h-[932px] w-full max-w-[430px] ">
        ...
        <div className="flex justify-center items-center flex-col gap-[40px] p-[2rem]">
          ...
          <p className="w-full md:w-10/12 lg:w-[43%] font-normal text-base lg:text-[18px] text-[#E1B5E5]  text-center">
             Step into the future of investing. CREIT combines high-performing
            Real  Estate dividends with the industry&apos;s leading trading bot,
            aiming to  offer the best revenue share in crypto. Simplify your
            path to wealth. 
          </p>
           <CustomButton>Read Whitepaper</CustomButton>
